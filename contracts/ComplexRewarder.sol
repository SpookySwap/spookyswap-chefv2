...
contract ComplexRewarderTime is IRewarder,  Ownable{
    ...
    address public immutable protocolOwnerAddress
    ...
    constructor (IERC20 _rewardToken, uint256 _rewardPerSecond, address _MASTERCHEF_V2, address _protocolOwnerAddress) public {
        rewardToken = _rewardToken;
        rewardPerSecond = _rewardPerSecond;
        MASTERCHEF_V2 = _MASTERCHEF_V2;
        protocolOwnerAddress = _protocolOwnerAddress
    }
    ...
    function recoverWrongTokens(address _tokenAddress) external onlyOwner {
        require(_tokenAddress != address(rewardToken), "recoverWrongTokens: Cannot be reward token");
    ...
    function emergencyRewardWithdraw(uint _pid, uint256 _amount) external onlyOwner {
        rewardToken.safeTransfer(ProtocolOwnerAddress, _amount);
    }
